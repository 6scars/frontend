...
export function About() {
  return (
    <div className="home-desc gradient-wrapper flex flex-col md:flex-row gap-5 w-full justify-center mt-10">
      <div id="About" className="home-left glass move2 flex-1 max-w-[100%] text-[1.4rem] items-center ">
        <h2 className="slide-down text-3xl font-bold mb-4">ABOUT</h2>
        <div className=" shadow-[0_0_50px_20px_rgba(0,0,0,0.55)] bg-black/67 border-3 rounded-[8%] border-black/90 p-6 max-w-[80%]
            max-sm:text-[1rem] max-sm:p-0 ">
          <div className="flex gap-10 items-center">
            ...
            <img alt="comet" src={comet} className="w-[10rem] h-[5rem] max-sm:w-[5rem] max-sm:h-[4rem]" />
          </div>
        </div>
        ...
        <div className="shadow-[0_0_50px_20px_rgba(0,0,0,0.55)] bg-black/67 border-3 rounded-[8%] border-black/90 p-6 max-w-[80%]">
          ...
          <div className="flex gap-10 items-center max-sm:text-[1rem] max-sm:p-0">
            ...
            <img alt="save" src={save} className=" w-[10rem] h-[10rem] max-sm:w-[5rem] max-sm:h-[5rem]" />
          </div>
        </div>
      </div>
    </div>
